  ...
  <div class="taovien">
    <?php
		...
		function listCatShow($cat,$sau,$webRoot,$languageMantan)
		{
			...
			<td align="center">
				<input class="input" type="button" value="<?php echo $languageMantan['edit'];?>" onclick="suaData('<?php echo @$cat['id'];?>','<?php echo @$cat['slug'];?>','<?php echo @$cat['key'];?>','<?php echo @$cat['description'];?>');">
				&nbsp;&nbsp;
...
function suaData(idCat,slug,key,description)
{
