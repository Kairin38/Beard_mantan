<?php
    ...
    $menus[0]['sub'][0]= array('name'=>'Liên kết web','classIcon'=>'fa-link','url'=>$urlPlugins.'admin/linkWeb-listLinkWeb.php');
    $menus[0]['sub'][1]= array('name'=>'Nhóm liên kết','classIcon'=>'fa-users','url'=>$urlPlugins.'admin/linkWeb-categoryLinkWeb.php');
