<?php
	...
	$menus[0]['sub'][0]= array('name'=>'Gửi email thông báo','url'=>$urlPlugins.'admin/subscribe-admin-send_subscribe.php','classIcon'=>'fa-envelope-o');
	$menus[0]['sub'][1]= array('name'=>'Danh sách email','url'=>$urlPlugins.'admin/subscribe-admin-list_subscribe.php','classIcon'=>'fa-list');
